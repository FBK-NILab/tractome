...
#
# Created: Fri Dec  5 18:16:13 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuAxial_Slice = QtGui.QMenu(self.menu3D_Slicer)
        self.menuAxial_Slice.setObjectName("menuAxial_Slice")
        self.menuCoronal_Slice = QtGui.QMenu(self.menu3D_Slicer)
        self.menuCoronal_Slice.setObjectName("menuCoronal_Slice")
        self.menuSaggital_Slice = QtGui.QMenu(self.menu3D_Slicer)
        self.menuSaggital_Slice.setObjectName("menuSaggital_Slice")
        ...
        self.menuAxial_Slice.addAction(self.actionShow_1)
        self.menuAxial_Slice.addAction(self.actionMove_Left_Left)
        self.menuAxial_Slice.addAction(self.actionMove_Right_Right)
        self.menuCoronal_Slice.addAction(self.actionShow_3)
        self.menuCoronal_Slice.addAction(self.actionMove_Up_Up)
        self.menuCoronal_Slice.addAction(self.actionMove_Down_Down)
        self.menuSaggital_Slice.addSeparator()
        self.menuSaggital_Slice.addAction(self.actionShow_2)
        self.menuSaggital_Slice.addAction(self.actionMoveFront_Up)
        self.menuSaggital_Slice.addAction(self.actionMoveBack_Down)
        self.menu3D_Slicer.addAction(self.actionShow_All_Slices_0)
        self.menu3D_Slicer.addAction(self.menuAxial_Slice.menuAction())
        self.menu3D_Slicer.addAction(self.menuSaggital_Slice.menuAction())
        self.menu3D_Slicer.addAction(self.menuCoronal_Slice.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuAxial_Slice.setTitle(QtGui.QApplication.translate("MainWindow", "Axial Slice", None, QtGui.QApplication.UnicodeUTF8))
        self.menuCoronal_Slice.setTitle(QtGui.QApplication.translate("MainWindow", "Coronal Slice", None, QtGui.QApplication.UnicodeUTF8))
        self.menuSaggital_Slice.setTitle(QtGui.QApplication.translate("MainWindow", "Saggital Slice", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionRemove_Selected_Back_Space.setText(QtGui.QApplication.translate("MainWindow", "Remove Selected                Backspace", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionShow_All_Slices_0.setText(QtGui.QApplication.translate("MainWindow", "Show All Slices          0", None, QtGui.QApplication.UnicodeUTF8))
        self.actionShow_1.setText(QtGui.QApplication.translate("MainWindow", "Show                           1", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionShow_2.setText(QtGui.QApplication.translate("MainWindow", "Show                           2", None, QtGui.QApplication.UnicodeUTF8))
        self.actionMoveFront_Up.setText(QtGui.QApplication.translate("MainWindow", "Move Back            PgDn", None, QtGui.QApplication.UnicodeUTF8))
        self.actionMoveBack_Down.setText(QtGui.QApplication.translate("MainWindow", "Move Front           PgUp", None, QtGui.QApplication.UnicodeUTF8))
        self.actionShow_3.setText(QtGui.QApplication.translate("MainWindow", "Show                           3", None, QtGui.QApplication.UnicodeUTF8))
        self.actionMove_Up_Up.setText(QtGui.QApplication.translate("MainWindow", "Move Up                   Up", None, QtGui.QApplication.UnicodeUTF8))
        self.actionMove_Down_Down.setText(QtGui.QApplication.translate("MainWindow", "Move Down          Down", None, QtGui.QApplication.UnicodeUTF8))
